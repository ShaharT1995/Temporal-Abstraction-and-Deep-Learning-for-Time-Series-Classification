...
class Classifier_MCNN:
    ...
    def split_train(self, train_x, train_y, iteration):
    ...
    def train(self, x_train, y_train, x_test, y_test, y_true, iteration, pool_factor=None, filter_size=None,
              do_train=True):
        window_size = 0.2
        n_train_batch = 10
        n_epochs = 200
        ...
        x_train, y_train, x_val, y_val = self.split_train(x_train, y_train, iteration)
