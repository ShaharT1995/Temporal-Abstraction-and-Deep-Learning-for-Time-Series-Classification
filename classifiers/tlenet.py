...
from utils_folder.utils import save_logs_t_leNet as save_logs, calculate_metrics
...
class Classifier_TLENET:
    ...
    def build_model(self, input_shape, nb_classes):
        ...
        model.compile(optimizer=keras.optimizers.Adam(lr=0.01, decay=0.005), loss='categorical_crossentropy',
                      metrics=['accuracy'])
